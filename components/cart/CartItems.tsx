		...
		<>
			<div className='cart-items'>
				<div className='cart-items__thead row'>
					...
					<div className='cart-items__thead-cell col-md-2'>Preț</div>
					<div className='cart-items__thead-cell col-md-2'>Cantitate</div>
				...
				<div className='cart-items__total-row row'>
					<div className='cart-items__total-cell cart-items__total-cell_title col-md-6'>Total:</div>
					<div className='cart-items__total-cell col-md-2'>
						<span className='cart-items__label'>Cantitate: </span>
						{total.qty}
					</div>
					<div className='cart-items__total-cell col-md-2'>
						<span className='cart-items__label'>Preț: </span>
						{total.price}
					</div>
				</div>
			</div>
			<div className='cart-items__actions'>
				...
				>
					Mergi spre finalizare <FontAwesomeIcon icon={faShoppingCart} />
				</button>
			</div>
		</>
	);
